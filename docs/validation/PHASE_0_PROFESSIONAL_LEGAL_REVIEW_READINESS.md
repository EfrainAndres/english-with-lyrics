# Phase 0 Professional Legal-Review Readiness
...
- The legal-owner implementation is complete and uses server-only configuration.
- Protected Preview final regression passed in `draft` mode.
- Both legal routes passed content, responsive, keyboard, focus, footer-link, robots and metadata privacy QA.
...
- Consent language, evidence and separation of resource delivery from optional communications.
- Rights procedures, identity validation and response timelines.
- Retention, deletion and minimum suppression records.
- Not-directed-to-minors strategy.
- Provider classification, contracts, DPA terms, subprocessors and international processing.
- RNBD applicability.
