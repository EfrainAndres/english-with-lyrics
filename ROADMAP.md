...
Goal: Confirm demand before building the platform.
...
- Waitlist.
- Founder offer.
- Clear positioning around Sing Pronunce Repeat, English with Lyrics, and Escríbelo como suena.
- Manual follow-up process for interested learners.

Key questions:

- Do learners understand the offer?
- Will they join the waitlist?
- Will they answer a survey?
- Will they pay or reserve access for a founder version?
...
## Phase 0.5: Free Ebook Lead Magnet

Goal: Grow the audience and validate educational content format.
...
- Do learners download the ebook?
...
Current Phase 0 step: PR #63 merged at `a09623178b41901a13cb799336dc0ae994a83e3e`, and the approved legal policies are configured and published on the canonical Production origin. Production legal environment configuration, Production deployment and canonical Production legal-route smoke QA pass, with approved-mode content, retained `noindex, nofollow`, metadata privacy, desktop and 390 px containment with no horizontal overflow, and a passing ebook and thank-you regression. The project owner then completed a canonical Production review directly against the live origin and approved both routes; the final Production legal-publication acceptance gate passes and the Production legal policies are LIVE / ACCEPTED. Rollback remains PREPARED / NOT EXECUTED. Legal publication does not activate the funnel and does not constitute certification or guaranteed compliance. Next is the explicit Production indexing decision, with `noindex, nofollow` retained until then. Final MailerLite consent linking, rights-request provider operations QA and controlled rollout remain later gates; lead capture, Email 1, email delivery and automation stay inactive while direct PDF delivery remains active.

Next order:

1. MailerLite domain authentication — complete.
2. Hostinger mailbox regression — complete.
3. Authenticated-sender Preview Email 1 regression — complete.
4. Canonical ebook PDF regeneration — complete.
5. Historical 21-page Production PDF smoke test — complete.
...
17. Legal-publication readiness — professional Colombian and provider contractual/DPA reviews PASS with no changes requested; approved-mode source, local pending/draft/approved QA and application privacy link PASS. Owner approved-mode rendered review — PASS on desktop and 390 px for `/privacidad` and `/tratamiento-de-datos`; horizontal overflow — NONE. Protected approved-mode Preview review — PASS. Approved-mode Preview readiness gate — PASS. PR #63 merge — PASS at `a09623178b41901a13cb799336dc0ae994a83e3e`. Production legal environment configuration, Production deployment and canonical Production legal-route smoke QA — PASS; approved-mode content, `noindex, nofollow`, metadata privacy, desktop and 390 px containment and the ebook/thank-you regression — PASS; horizontal overflow — NONE. Project-owner canonical Production legal review — PASS, both routes desktop and 390 px against the live origin. Final Production legal-publication acceptance gate — PASS. Production legal policies — LIVE / ACCEPTED. PR #64 — approved for merge; not merged. Rollback — PREPARED / NOT EXECUTED. Production indexing decision, Production MailerLite form/consent linking and rights-request provider operations QA — pending.
...
- 5 songs converted into 25 micro-lessons.
- Drip content.
- Short quizzes.
- Simple progress tracking.
- Real COP payments.
- Basic access management.
- Embedded official YouTube videos when needed.

Key questions:

- Will users pay in COP?
- Will users complete lessons?
- Which songs and lesson formats create the most engagement?
- Does the method improve confidence and comprehension?

## Phase 2: SEO And Content Expansion

Goal: Turn validated content into discoverable web pages.

Potential deliverables:

- SEO-friendly song lesson previews.
- Topic pages for pronunciation patterns.
- More songs.
- Internal linking between lessons.
- Public educational snippets that do not replace lyrics.

## Phase 3: Community And Social Impact

Goal: Expand access and trust.

Potential deliverables:

- Social scholarships.
- Partnerships with schools, teachers, or community groups.
- Cohort experiments.
- Testimonials and learner stories.

## Phase 4: Advanced Product

Goal: Add technology only after core learning demand is proven.
...
- Teacher or partner dashboards.

## Roadmap Guardrails

- Do not build the app before Phase 0 validation assets are ready.
- Do not add payments before the founder offer is clear.
- Do not add AI before there is enough real lesson content and learner behavior.
- Do not create full-lyrics pages.
- Keep the web app as the first product surface.
