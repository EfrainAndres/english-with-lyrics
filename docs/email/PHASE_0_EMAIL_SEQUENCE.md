...
- Content status: Email 1 ready for Preview manual configuration.
...
- Do not activate the Production sequence until legal, privacy, sender-domain, and deliverability blockers are cleared.
